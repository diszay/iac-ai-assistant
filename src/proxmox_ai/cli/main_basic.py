"""
Basic CLI application for Proxmox AI Assistant (without enterprise features).

This version excludes heavy dependencies and enterprise features for testing
and environments with limited dependencies.
"""
...
def create_app() -> typer.Typer:
    ...
    # Add subcommands (excluding enterprise features for now)
